...
const CreateTask = () => {
  return (
    <div className="p-5 bg-[#1c1c1c] mt-7 rouned">
        <form className=" flex flex-wrap w-full  items-start justify-between">
          <div className="w-1/2">
            ...
            <div>
              ...
              <input className="text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4" type="text" placeholder="empolyee name"/>
            </div>
            <div>
